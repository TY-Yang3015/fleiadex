...
def execute_diffuser(config_dir: str) -> None:
    """
    execute the diffuser with the specified YAML config file.
    ...
    def execute_diffuser(config: LDMConfig | ConditionalDDPMConfig) -> None:
        ...
        from fleiadex.trainers import get_diffuser_trainer
